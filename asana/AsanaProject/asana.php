...
class Asana {
    ...
    public function createTask($data){
        ...
        return $this->askAsana($this->taskUrl, $dataJSON, METHOD_POST);
    }
    ...
    public function updateTask($taskId, $data){
        $data = array("data" => $data);
        $dataJSON = json_encode($data);
        return $this->askAsana($this->taskUrl."/{$taskId}", $dataJSON, METHOD_PUT);
    }
    ...
    public function addProjectToTask($taskId, $projectId){
        ...
        $dataJSON = json_encode($data);
        return $this->askAsana($this->taskUrl."/{$taskId}/addProject", $dataJSON, METHOD_POST);
    }
    ...
    public function removeProjectToTask($taskId, $projectId){
        $data = array("data" => array("project" => $projectId));
        $dataJSON = json_encode($data);
        return $this->askAsana($this->taskUrl."/{$taskId}/removeProject", $dataJSON, METHOD_POST);
    }
    ...
    public function commentOnTask($taskId, $text = ""){
        ...
        $dataJSON = json_encode($data);
        return $this->askAsana($this->taskUrl."/{$taskId}/stories", $dataJSON, METHOD_POST);
    }
    ...
    public function addTagToTask($taskId, $tagId){
        ...
        $dataJSON = json_encode($data);
        return $this->askAsana($this->taskUrl."/{$taskId}/addTag", $dataJSON, METHOD_POST);
    }
    ...
    public function removeTagFromTask($taskId, $tagId){
        $data = array("data" => array("tag" => $tagId));
        $dataJSON = json_encode($data);
        return $this->askAsana($this->taskUrl."/{$taskId}/removeTag", $dataJSON, METHOD_POST);
    }
    ...
    public function createProject($data){
        $data = array("data" => $data);
        $dataJSON = json_encode($data);
        return $this->askAsana($this->projectsUrl, $dataJSON, METHOD_POST);
    }
     ...
     */
    public function getProjects($archived = false, $opt_fields = "name,notes,modified_at"){
    ...
    public function updateProject($projectId, $data){
        $data = array("data" => $data);
        $dataJSON = json_encode($data);
        return $this->askAsana($this->projectsUrl."/{$projectId}", $dataJSON, METHOD_PUT);
    }
     ...
     * @return string JSON or null 
     */
    public function getProjectTasks($projectId,$opt_fields = "name,notes,modified_at,completed"){
         $opt_fields = ($opt_fields != "")?"&opt_fields={$opt_fields}":"";
        return $this->askAsana($this->taskUrl."?project={$projectId}{$opt_fields}");
    }
    ...
    public function commentOnProject($projectId, $text = ""){
        ...
        return $this->askAsana($this->projectsUrl."/{$projectId}/stories", $jsonData, METHOD_POST);
    }
    ...
    public function updateTag($tagId, $data){
        $data = array("data" => $data);
        $dataJSON = json_encode($data);
        return $this->askAsana($this->tagsUrl."/{$tagId}", $dataJSON, METHOD_PUT);
    }
    ...
    public function updateWorkspace($workspaceId, $data = array("name" => "")){
        $data = array("data" => $data);
        $dataJSON = json_encode($data);
        return $this->askAsana($this->workspaceUrl."/{$workspaceId}", $dataJSON, METHOD_PUT);
    }
